...
public class RusLetterValidatorMessageMapper implements MessageMapper<ValidatorException> {
    @Override
    ...
    private enum Converter {
        ...
        LETTER_NOT_CYRILLIC(RusLetterValidator.Result.LETTER_NOT_IN_LANGUAGE, "Допустимы только буквы кириллицы!"),
